...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static bool BaseGradebook { get; private set; }
        public static bool StandardGradebook { get; private set; }
        public static bool RankedGradebook { get; private set; }
        ...
        public static void CreateCommand(string command)
        {
            ...
            //BaseGradeBook gradeBook = new BaseGradeBook(name,BaseGradebook);
            if (parts[2].ToLower() == "standard")
            {
                GradeBook = new StandardGradeBook(name,StandardGradebook);
            }
            else if(parts[2].ToLower() == "ranked")
            {
                GradeBook = new RankedGradeBook(name,RankedGradebook);
            }
            else if(parts[2] != "standard" & parts[2] != "ranked")
            {
                Console.WriteLine(parts[2] + "incorrect is not a supported type of gradebook, please try again");
                return;
            }
